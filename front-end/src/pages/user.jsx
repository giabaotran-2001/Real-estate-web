...
import "./user.css";
import Chatbot from "../components/base/Chatbot/Chatbot";
...
const LandForSaleProvince = React.lazy(() =>
  import("../components/land-for-sale-province/land-for-sale-province")
);
...
const NewsDetail = React.lazy(() => import("../components/news-detail"));
      ...
      <Fragment>
        <Router>
          ...
          <Switch>
            ...
            <Route
              exact
              path="/user/land-for-sale/:idType"
              component={LandForSale}
            />
            <Route
              exact
              path="/user/land-for-rent/:idType"
              component={LandForRent}
            />
            <Route
              exact
              path="/user/land-for-sale-province/:id"
              component={LandForSaleProvince}
            />
